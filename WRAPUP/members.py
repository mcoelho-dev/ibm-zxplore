...
if (datasets.exists(dsname) == True):
    ...
    if (create_new.upper() == "Y"):
        ...
        # datasets.create(dsname,"???",primary_space="1k",secondary_space="1k")
...
#
# 2024-08-08 update - new version of ZOAU
# https://www.ibm.com/docs/en/zoau/1.3.x?topic=apis-datasets
